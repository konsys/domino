...
interface IStype {
  board: CSSProperties;
  playable: CSSProperties;
  path: CSSProperties;
  status: CSSProperties;
  gameInfo: CSSProperties;
  icon: CSSProperties;
  playerInfo: CSSProperties;
  fichaStyling:
    | {
        fichaDisplayLeft: CSSProperties;
        fichaDisplayRight: CSSProperties;
        fichaDisplayMinus90: CSSProperties;
        fichaDisplayPlus90: CSSProperties;
      }
    | any;
}
export const BOARD_STYLES: IStype = {
  board: {
    height: '100vh',
